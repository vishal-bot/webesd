...
<html lang="en">
  ...
  <div class="row">
    <div class="col-md-8 blog-main">
      <div class="blog-post">
      <span id="articleH" class="d-block p-2 bg-dark text-white text-monospace text-center" ><h3>Datasheets</h3></span>
      <div style="margin-top:10px; margin-bottom:10px;"></div>
      <form class="form-inline">
    <input class="form-control mr-sm-2" type="search" placeholder="Search Datasheets" aria-label="Search">
